...
module HLS_FIR_FIR_filter_392_Pipeline_VITIS_LOOP_32_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [63:0] zext_ln34_fu_78_p1;
wire    ap_block_pp0_stage0;
wire   [63:0] zext_ln32_fu_88_p1;
reg   [8:0] i_fu_28;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln32_fu_66_p2 == 1'd0) & (ap_start_int == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln32_fu_66_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    ap_enable_operation_14 = (icmp_ln32_fu_66_p2 == 1'd0);
end
...
assign icmp_ln32_fu_66_p2 = ((ap_sig_allocacmp_i_2 == 9'd391) ? 1'b1 : 1'b0);

assign zext_ln32_fu_88_p1 = i_2_reg_99;

assign zext_ln34_fu_78_p1 = add_ln34_fu_72_p2;

endmodule //HLS_FIR_FIR_filter_392_Pipeline_VITIS_LOOP_32_1
