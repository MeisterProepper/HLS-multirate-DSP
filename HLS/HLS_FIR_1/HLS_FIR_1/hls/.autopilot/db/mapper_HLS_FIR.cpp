...
using hls::sim::Byte;
extern "C" void HLS_FIR(short*, short*);
extern "C" void apatb_HLS_FIR_hw(volatile void * __xlx_apatb_param_input_r, volatile void * __xlx_apatb_param_output_r) {
...
auto* soutput_r = createStream((hls::stream<short>*)__xlx_apatb_param_output_r);
  // DUT call
  HLS_FIR(sinput_r->data<short>(), soutput_r->data<short>());
