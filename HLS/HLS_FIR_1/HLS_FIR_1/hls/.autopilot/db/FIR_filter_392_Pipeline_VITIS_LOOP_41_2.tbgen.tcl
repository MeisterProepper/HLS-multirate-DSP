set moduleName FIR_filter_392_Pipeline_VITIS_LOOP_41_2
set isTopModule 0
...
set cdfgNum 6
set C_modelName {FIR_filter<392>_Pipeline_VITIS_LOOP_41_2}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict H_filt_FIR { MEM_WIDTH 16 MEM_SIZE 784 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ FIR_accu32_out int 31 regular {pointer 1}  }
	{ H_filt_FIR int 16 regular {array 392 { 1 3 } 1 1 } {global 0}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "FIR_accu32_out", "interface" : "wire", "bitwidth" : 31, "direction" : "WRITEONLY"} , 
 	{ "Name" : "H_filt_FIR", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ H_filt_FIR_address0 sc_out sc_lv 9 signal 1 } 
	{ H_filt_FIR_ce0 sc_out sc_logic 1 signal 1 } 
	{ H_filt_FIR_q0 sc_in sc_lv 16 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "H_filt_FIR_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "H_filt_FIR", "role": "q0" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_16s_14s_32s_32_4_1_U2", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	H_filt_FIR { ap_memory {  { H_filt_FIR_address0 mem_address 1 9 }  { H_filt_FIR_ce0 mem_ce 1 1 }  { H_filt_FIR_q0 mem_dout 0 16 } } }
}
