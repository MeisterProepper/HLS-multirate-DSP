...
// tvout file define:
#define AUTOTB_TVOUT_PC_output_r "../tv/rtldatafile/rtl.HLS_FIR.autotvout_output_r.dat"
...
extern "C"
void HLS_FIR_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_HLS_FIR_hw(void* __xlx_apatb_param_input_r, void* __xlx_apatb_param_output_r)
{
  ...
  try {
    ...
    HLS_FIR_hw_stub_wrapper(__xlx_apatb_param_input_r, __xlx_apatb_param_output_r);
    port1.buffer();
