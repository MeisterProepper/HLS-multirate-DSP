...
`define AUTOTB_DUT      HLS_FIR
`define AUTOTB_DUT_INST AESL_inst_HLS_FIR
`define AUTOTB_TOP      apatb_HLS_FIR_top
`define AUTOTB_LAT_RESULT_FILE "HLS_FIR.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "HLS_FIR.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_HLS_FIR_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00
`define AUTOTB_II 798
`define AUTOTB_LATENCY 797

`define AESL_DEPTH_input_r 1
`define AESL_DEPTH_output_r 1
`define AUTOTB_TVIN_input_r  "../tv/cdatafile/c.HLS_FIR.autotvin_input_r.dat"
`define AUTOTB_TVIN_input_r_out_wrapc  "../tv/rtldatafile/rtl.HLS_FIR.autotvin_input_r.dat"
`define AUTOTB_TVOUT_output_r  "../tv/cdatafile/c.HLS_FIR.autotvout_output_r.dat"
`define AUTOTB_TVOUT_output_r_out_wrapc  "../tv/rtldatafile/rtl.HLS_FIR.autotvout_output_r.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 460;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 797;
...
// Dependence Check (WAR) "ap_enable_operation_20"(R:SV0-1) -> "ap_enable_operation_22"(W:SV1-1) @ `AUTOTB_DUT_INST.grp_FIR_filter_392_s_fu_49.grp_FIR_filter_392_Pipeline_VITIS_LOOP_32_1_fu_39
