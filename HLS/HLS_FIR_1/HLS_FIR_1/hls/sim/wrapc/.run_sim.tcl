...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "HLS_FIR.autotvin.dat"
	set constFileTvOut       "HLS_FIR.autotvout.dat"
	set constFileHdlTvIn     "HLS_FIR.autohdltvin.dat"
	set constFileHdlTvOut    "HLS_FIR.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
