...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "FIR_HLS.autotvin.dat"
	set constFileTvOut       "FIR_HLS.autotvout.dat"
	set constFileHdlTvIn     "FIR_HLS.autohdltvin.dat"
	set constFileHdlTvOut    "FIR_HLS.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
