set moduleName FIR_filter_2_Pipeline_VITIS_LOOP_69_2
set isTopModule 0
...
set cdfgNum 11
set C_modelName {FIR_filter.2_Pipeline_VITIS_LOOP_69_2}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict FIR_delays { MEM_WIDTH 16 MEM_SIZE 10 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ FIR_delays int 16 regular {array 5 { 0 1 } 1 1 }  }
}
set hasAXIMCache 0
...
set Spec2ImplPortList { 
	FIR_delays { ap_memory {  { FIR_delays_address0 mem_address 1 3 }  { FIR_delays_ce0 mem_ce 1 1 }  { FIR_delays_we0 mem_we 1 1 }  { FIR_delays_d0 mem_din 1 16 }  { FIR_delays_address1 MemPortADDR2 1 3 }  { FIR_delays_ce1 MemPortCE2 1 1 }  { FIR_delays_q1 MemPortDOUT2 0 16 } } }
}
