set moduleName FIR_filter_Pipeline_VITIS_LOOP_69_2
set isTopModule 0
...
set cdfgNum 11
set C_modelName {FIR_filter_Pipeline_VITIS_LOOP_69_2}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict FIR_delays { MEM_WIDTH 16 MEM_SIZE 12 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ FIR_delays int 16 regular {array 6 { 0 1 } 1 1 }  }
}
set hasAXIMCache 0
