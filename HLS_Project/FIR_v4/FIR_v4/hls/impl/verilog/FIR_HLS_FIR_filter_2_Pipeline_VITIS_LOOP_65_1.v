...
module FIR_HLS_FIR_filter_2_Pipeline_VITIS_LOOP_65_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
FIR_HLS_mac_muladd_16s_15s_32s_32_4_1 #(
    .ID( 1 ),
    .NUM_STAGE( 4 ),
    .din0_WIDTH( 16 ),
    .din1_WIDTH( 15 ),
...
assign FIR_coe_address0 = zext_ln65_fu_102_p1;

assign FIR_coe_ce0 = FIR_coe_ce0_local;

assign FIR_delays_address0 = zext_ln66_fu_113_p1;

assign FIR_delays_ce0 = FIR_delays_ce0_local;

assign add_ln65_fu_96_p2 = (ap_sig_allocacmp_i_3 + 3'd1);
...
assign icmp_ln65_fu_90_p2 = ((ap_sig_allocacmp_i_3 == 3'd5) ? 1'b1 : 1'b0);

assign sub_ln66_fu_107_p2 = ($signed(3'd4) - $signed(ap_sig_allocacmp_i_3));

assign zext_ln65_fu_102_p1 = ap_sig_allocacmp_i_3;

assign zext_ln66_fu_113_p1 = sub_ln66_fu_107_p2;

endmodule //FIR_HLS_FIR_filter_2_Pipeline_VITIS_LOOP_65_1
