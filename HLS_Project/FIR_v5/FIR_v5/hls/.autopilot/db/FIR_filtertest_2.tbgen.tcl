set moduleName FIR_filtertest_2
set isTopModule 0
...
set cdfgNum 10
set C_modelName {FIR_filtertest.2}
set C_modelType { int 16 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict FIR_delays { MEM_WIDTH 32 MEM_SIZE 20 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
...
set C_modelArgList {
	{ FIR_delays int 32 regular {array 5 { 2 1 } 1 1 }  }
...
set portList { 
	...
	{ FIR_delays_d0 sc_out sc_lv 32 signal 0 } 
	{ FIR_delays_q0 sc_in sc_lv 32 signal 0 } 
	{ FIR_delays_address1 sc_out sc_lv 3 signal 0 } 
	{ FIR_delays_ce1 sc_out sc_logic 1 signal 0 } 
	{ FIR_delays_q1 sc_in sc_lv 32 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "FIR_delays_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "FIR_delays", "role": "q0" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "4"],
		...
		"Port" : [
			{"Name" : "FIR_delays", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_FIR_filtertest_2_Pipeline_VITIS_LOOP_83_1_fu_56", "Port" : "FIR_delays", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "FIR_coe", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_FIR_filtertest_2_Pipeline_VITIS_LOOP_83_1_fu_56", "Port" : "FIR_coe", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "x_n", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_FIR_filtertest_2_Pipeline_VITIS_LOOP_83_1_fu_56", "Parent" : "0", "Child" : ["2", "3"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_FIR_filtertest_2_Pipeline_VITIS_LOOP_83_1_fu_56.mul_16s_15s_31_1_1_U1", "Parent" : "1"},
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_FIR_filtertest_2_Pipeline_VITIS_LOOP_83_1_fu_56.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_15s_16s_31_1_1_U6", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	FIR_delays { ap_memory {  { FIR_delays_address0 mem_address 1 3 }  { FIR_delays_ce0 mem_ce 1 1 }  { FIR_delays_we0 mem_we 1 1 }  { FIR_delays_d0 mem_din 1 32 }  { FIR_delays_q0 mem_dout 0 32 }  { FIR_delays_address1 MemPortADDR2 1 3 }  { FIR_delays_ce1 MemPortCE2 1 1 }  { FIR_delays_q1 MemPortDOUT2 0 32 } } }
